...
This is a __RocksDB__ fork of LevelDOWN. It uses almost the same exact code as
LevelDOWN. The only thing that has changed is the build process. The original
LevelDOWN resides here: https://github.com/Level/leveldown.
